...
import spring.service.dice.impl.DiceBlmpl;
import spring.service.dice.impl.DiceAlmpl;
...
public class DiceTestApp02 {
	...
	public static void main(String[] args){
		...
		Player02 player01 = new Player02(new DiceAlmpl());
		player01.playDice(3);
		System.out.println("=======================");
		...
		player02.setDice(new DiceBlmpl());
		player02.playDice(3);
