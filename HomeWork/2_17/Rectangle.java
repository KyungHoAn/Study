...
public class Rectangle {
	...
	public static void main(String[] args) {
		...
		if(rec1.area()>rec2.area()) {
			System.out.println("넓이는"+rec1.getColor()+"가 더 큽니다.");
		}else if(rec1.area()<rec2.area()){
			System.out.println("넓이는"+rec2.getColor()+"가 더 큽니다.");
		}else {
		...
		if(rec1.perimeter()>rec2.perimeter()) {
			System.out.println("둘레는"+rec1.getColor()+"가 더 큽니다.");
		}else if(rec1.perimeter()<rec2.perimeter()){
			System.out.println("둘레는"+rec2.getColor()+"가 더 큽니다.");
		} else {
