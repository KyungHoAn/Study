...
public class OperatorTest {
	...
	public static void main(String[] args){
		...
		int temp = value++; //temp = value++의미: value의 값을 temp대입 후 자기자신 1증
		//int temp = value--; //temp = value--의미: value의 값을 temp대입 후 자기자신 1감소
		//int temp = ++value; //temp = ++value의미:value 자기자신에 1증가 그 값 temp 대입
		//int temp = --value; //temp = --value의미:value 자기자신에 1rkath 그 값 temp 대입
